...
const isActive = computed(() => chat.activeContact === props.user?.id);
...
<template>
    <div class="flex items-center gap-3 my-1 p-3 shadow-md rounded-2xl cursor-pointer" :class="isActive ? 'bg-blue-500' : ''">
        <div
            class="bg-blue-400 w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-lg basis-3/12">
            A</div>
